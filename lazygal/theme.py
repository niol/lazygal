...
class Theme(object):
    ...
    def prepare_tpl_loader(self, tplfactory):
        self.tpl_loader = tplfactory(os.path.join(self.themes_dir,
                                                  DEFAULT_THEME),
                                     self.tpl_dir)
    ...
    def __load_manifest(self):
        ...
        for s in theme_manifest['shared']:
            ...
            if 'dest' in s:
                ...
                if shared['dest'].endswith('/'): # this is a directory
                    shared['dest'] = os.path.join(shared['dest'],
                        os.path.basename(shared['source']))
            else:
        ...
        for s in glob.glob(os.path.join(self.tpl_dir,
